...
export function MiddleSchoolTeachers() {
  const teachers = [
    { name: "정민수 선생님", subject: "중등 수학 전 과정", exp: "경력 12년", desc: "기본기를 탄탄히 잡아주는 맞춤형 수업. 중등 내신 만점자 다수 배출." },
    { name: "한지영 선생님", subject: "중등 심화·선행", exp: "경력 9년", desc: "개념 이해부터 고난도 문제까지. 고등 수학 선행 전문." },
  ];
  return (
