...
start_marker = "function BriefingsTab() {"
end_marker = "function BriefingEventsTab() {"

start_idx = content.find(start_marker)
end_idx = content.find(end_marker)

if start_idx != -1 and end_idx != -1:
    new_briefings = """function BriefingsTab() {
...
"""
    ...
    new_content = content[:start_idx] + new_briefings + content[end_idx:]
    with open('client/src/pages/admin.tsx', 'w') as f:
        f.write(new_content)
    print("BriefingsTab replaced successfully.")
else:
