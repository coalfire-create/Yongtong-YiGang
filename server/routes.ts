  ...
  try {
    ...
    const entries = [
      ...
      { division:'고1', category:'curriculum', display_order:34,
        ...
        content:"[수업 일정]\n금 16:30~20:00 (총 5회), 토 수업과 동일하므로 필요시 대체등원 가능\n\n[강좌 특징]\n·부족한 부분을 메꾸는 방학특강 + 2학기 내신 준비가 더해진 하이브리드 수업\r\n·화성고 기출 기반+ 학생들이 가장 어려워하는 어법/빈칸/순서/삽입 집중 공략\r\n·약점을 위한 개별과제 (예: 문장삽입이 약함 → 선별된 문장삽입 40제 확인/질답)\n\n[교재/제공자료]\n· 방학용 자체 교재 <수능열음> (어법 및 독해문제 단권화) \r\n· 나만의 노트 (오답 정리용 영어 학습 플래너)\r\n· 약점유형별 추가 40문제 소책자 (개별과제 용)\n\n[과제/TEST]\n과제용 주간지, 화성고 기출 및 변형 TEST\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 미흡한 학생들만 클리닉 진행 (금 수업 후 2시간)\n• 테스트: 워드 마스터 2학기 수행대비 + 배운 내용에 대한 테스트 결과 주간 리포트 발송\n• 클리닉: 강사 직접 진행, 부족한 부분에 대해 질답\n• 개강일: 7/10(금)  - 여름방학이 짧기 때문에 큰 변화를 주기보다는 내실을 다지는 것에 집중\n• 1회차 7/10(금): 어법) 필수 개념정리 및 모두 고르시오 문제에 적용하기 + 화성고 어법기출\n• 2회차 7/17(금): 빈칸) 문맥상 동의어와 G코드로 오답선지의 틀린 부분 딴지 걸기 + 화성고 빈칸기출\n• 3회차 7/24(금): 삽입) 주어진 글을 보지 않고 단절을 발견하기 (소/연/대/지 훈련1) + 화성고 삽입기출\n• 4회차 7/31(금): 순서) 선지 구성만으로도 글의 흐름 유추하기 (소/연/대/지 훈련2) + 화성고 순서기출\n• 5회차 8/7(금): 기타) 2학기 내신/모의고사 1등급을 위한 세부전략 + 화성고 기타유형기출 (제목 등)\n• 휴강공지: 8/14(금) 휴강 - 온오프 수업 없음\n\n[회차별 내용]\n• 개강일 / 회차: 8/21(금) 화성고 1학년 2학기 중간대비 내신개강" },
      { division:'고1', category:'curriculum', display_order:35,
        title:"[고등] 영어 - 대니얼T [화성고1]",
        content:"[수업 일정]\n토 18:30~22:00 (총 5회), 금 수업과 동일하므로 필요시 대체등원 가능\n\n[강좌 특징]\n부족한 부분을 메꾸는 방학특강 + 2학기 내신 준비가 더해진 하이브리드 수업\r\n화성고 기출 기반+ 학생들이 가장 어려워하는 어법/빈칸/순서/삽입 집중 공략\r\n약점을 위한 개별과제 (예: 문장삽입이 약함 → 선별된 문장삽입 40제 확인/질답)\n\n[교재/제공자료]\n방학용 자체 교재 <수능열음> (어법 및 독해문제 단권화) \r\n나만의 노트 (오답 정리용 영어 학습 플래너)\r\n학생 요청 시 약점유형에 해당하는 40문제가 수록된 소책자 제공\n\n[과제/TEST]\n과제용 주간지, 화성고 기출 및 변형 TEST\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 미흡한 학생들만 클리닉 진행 (토 수업 전 1.5시간, 금 20:00~22:00 활용 가능)\n• 테스트: 워드 마스터 2학기 수행대비 + 배운 내용에 대한 테스트 결과 주간 리포트 발송\n• 클리닉: 강사 직접 진행, 부족한 부분에 대해 질답\n• 개강일: 7/11(토)  - 여름방학이 짧기 때문에 큰 변화를 주기보다는 내실을 다지는 것에 집중\n• 1회차 7/11(토): 어법) 필수 개념정리 및 모두 고르시오 문제에 적용하기 + 화성고 어법기출\n• 2회차 7/18(토): 빈칸) 문맥상 동의어와 G코드로 오답선지의 틀린 부분 딴지 걸기 + 화성고 빈칸기출\n• 3회차 7/25(토): 삽입) 주어진 글을 보지 않고 단절을 발견하기 (소/연/대/지 훈련1) + 화성고 삽입기출\n• 4회차 8/1(토): 순서) 선지 구성만으로도 글의 흐름 유추하기 (소/연/대/지 훈련2) + 화성고 순서기출\n• 5회차 8/8(토): 기타) 2학기 내신/모의고사 1등급을 위한 세부전략 + 화성고 기타유형기출 (제목 등)\n• 휴강공지: 8/15(토) 휴강 - 온오프 수업 없음\n\n[회차별 내용]\n• 개강일 / 회차: 8/22(토) 화성고 1학년 2학기 중간대비 내신개강" },
      { division:'고2', category:'curriculum', display_order:36,
      ...
      { division:'고1', category:'curriculum', display_order:37,
      ...
      { division:'중등', category:'curriculum', display_order:38,
      ...
      { division:'고1', category:'curriculum', display_order:39,
      ...
      { division:'중등', category:'curriculum', display_order:41,
      ...
      { division:'고1', category:'curriculum', display_order:45,
      ...
      { division:'고2', category:'curriculum', display_order:47,
        title:"[고2] 수학 - 최주용T [확통]",
        content:"[수업 일정]\n7월 11일 개강 / 토 09:30-13:00\n\n[강좌 특징]\n화성고2 내신 1등급을 목표로 하는 학생\n\n[교재/제공자료]\n자체교재\n\n[과제/TEST]\n자체 워크북 (모의고사 준킬러 / 내신고쟁이 수준)\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 매시간 수업 시작전 수거 후 검사, 개인별 오답노트 제공\n• 테스트: 1교시 (09:05-09:30) / 첨삭 및 개인별 오답노트 제공\n• 클리닉: 금 17:00-21:00\n• 1회차: 여러가지 순열\n• 2회차: 중복조합\n• 3회차: 이항정리\n• 4회차: 확률의 뜻과 활용\n• 5회차: 조건부확률\n• 6회차: 확률변수와 확률분포\n• 7회차: 이항분포와 정규분포\n\n[회차별 내용]\n• 개강일 / 회차: 통계적 추정" },
      { division:'중등', category:'curriculum', display_order:48,
        title:"[중3] 수학 - 최주용T [공통수학2]",
        content:"[수업 일정]\n7월 23일 개강 / 화, 목 09-12:30\n\n[강좌 특징]\n중3 최상위권 학생 대상\n\n[교재/제공자료]\n자체교재\n\n[과제/TEST]\n자체 워크북 (모의고사 준킬러~킬러 / 블랙라벨 수준)\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 매시간 수업 시작전 수거 후 검사, 개인별 오답노트 제공\n• 테스트: 1교시 (09:05-09:30) / 개인별 오답노트 제공\n• 클리닉: 월~목 13:30~17:00\n• 1회차: 평면좌표와 직선의 방정식\n• 2회차: 직선의 방정식\n• 3회차 ): 원의 방정식\n• 4회차: 도형의 이동\n• 5회차: 집합\n• 6회차: 명제\n• 7회차: 함수\n\n[회차별 내용]\n• 개강일 / 회차: 합성함수와 역함수" },
      { division:'고1', category:'curriculum', display_order:49,
      ...
      { division:'고2', category:'curriculum', display_order:50,
      ...
      { division:'고1', category:'curriculum', display_order:52,
