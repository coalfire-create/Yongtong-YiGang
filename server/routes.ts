  ...
  try {
    ...
    const entries = [
      ...
      { division:'고1', category:'curriculum', display_order:10,
        ...
        content:"[수업 일정]\n화목19:00-21:00\n\n[강좌 특징]\n① 오개념이 없어지는 수업\n\n[교재/제공자료]\n② 개념과 풀이의 간극을 없애는 수업\n\n[과제/TEST]\n③ 최적의 풀이를 찾아내는 수업\n\n[관리 SYSTEM 및 CLINIC]\n• ④ 킬러는 빠르고 정확하게, 비킬러는 절대 틀리지 않게 하는 전략적 분리 수업: ④ 킬러는 빠르고 정확하게, 비킬러는 절대 틀리지 않게 하는 전략적 분리 수업\n• 본 교재(Secret Chemistry) / 주차별 자료: 본 교재(Secret Chemistry) / 주차별 자료\n• 서답형, 객관식을 포함한 내신, 평가원 기출 약 20문항: 서답형, 객관식을 포함한 내신, 평가원 기출 약 20문항\n• 과제 체크: 조교를 통한 대면 체크\n• 테스트: 오답 교정 후 귀가 조치 / 점수 미달 시 개인 Clinic 과제 부여\n• 클리닉: 수업 후 ~ 22:00 / 카카오톡, 유튜브를 통한 온라인 클리닉\n\n[회차별 내용]\n• 개강일 / 회차: 7/21(화)/ 8회\n• 1회차: 공유결합과 결합의 극성\n• 2회차: 분자의 구조와 극성\n• 3회차: 화학식량과 몰\n• 4회차: 화학반응식\n• 5회차: 동적평형과 평형 상수\n• 6회차: 평형 이동의 법칙\n• 7회차: 몰 농도와 물의 자동 이온화\n• 8회차: 중화반응\n\n[연계 강좌]\n• 방학 기간 중: 통합과학연합(토18:30-21:30)\n• 썸머 종강 후: 가온고1 통합과학" },
      { division:'고1', category:'curriculum', display_order:30,
        title:"[고등] 통합과학연합- 변현수 [가온고1]",
      ...
      { division:'고2', category:'curriculum', display_order:14,
        ...
        content:"[수업 일정]\n토16:30-19:30\n\n[강좌 특징]\n화성고, 대치 내신 기출과 학교자료를 철저히 분석한 개념교재\n해든누리T 홈페이지를 통한 완벽한 관리(자료, 영상 무한제공)\n숙제, test를 끝까지 책임지는 끈질긴 클리닉\n유형별, 단계별 문제풀이 훈련으로 Short-cut skill 체화\n고등학교 기출문제 기반의 수준별 문항으로 구성된 주간지 제공\n강사 직접 문제풀이에 필요한 풀이법을 손필기로 정리해서 제공\n\n[교재/제공자료]\nDrawing 개념교재\nReboot 기출분석교재\n\n[과제/TEST]\n주차별 주간지 Algorithm 제공\n매 회차 누리고사 진행\n클리닉 test 제공\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 주차별 주간지 완성도 체크\n미완성시 영상으로 제출해야함(엄톡방-학부모가 함께 참여하는 수업 단톡방)\n• 테스트: 주차별 누리고사 진행\n평균 미달시 클리닉 test 제공(100점 통과)\n• 클리닉: 복습 test 오답분석\n카카오톡을 이용한 24시간 클리닉\n\n[회차별 내용]\n• 개강일 / 회차: 7/17(금)/ 5회\n• 1회차: 이상기체상태방정식과 혼합기체\n• 2회차: 분자의 상호작용과 액체의 증기압력\n• 3회차: 물의 성질과 용액의 농도\n• 4회차: 묽은 용액의 총괄성\n• 5회차: 반응엔탈피와 헤스의 법칙\n\n[연계 강좌]\n• 방학 기간 중: 화학1 개념완성\n• 썸머 종강 후: 화성고2 내신대비" },
      { division:'중등', category:'curriculum', display_order:15,
        title:"[중등] 통과 - 황준우T [중3]",
        content:"[수업 일정]\n토 10:00-13:00\n\n[강좌 특징]\n\"서울대 전공자의 뇌를 그대로 이식받는, 황준우 SCHEMA 과학\"\n\n1. 모든 개념을 스토리텔링, 암기하지 않고도 기억하는 비법 강의!\n2. 개념과 문제의 1:1 대응, 모든 개념을 '실전화'한 실전 개념 강의!\n3. 물리/화학도 더 이상 두렵지 않다, 킬러 유형별 풀이 알고리즘 강의!\n4. 생물/지구도 암기로는 부족하다, 학교별 빈출 함정과 자료의 패턴 강의!\n5. 단순 선행이 아니다, 고등 성적을 미리 완성하는, 최고가 되기 위한 수업!\n\n[교재/제공자료]\n1. 개념 : SCIENCE - SCHEMA 1 + SELF - SCHEMA 주간지 \n\n- 기본 개념 : 교과서 모든 개념을 '암기' 없이 '기억'하는 법 학습\n- 실전 개념 : 물화생지 모든 개념을 '실전화'한 풀이 알고리즘 분석 \n- 자료 분석 : 강남/영통권 빈출 그림, 실험, 그래프 완벽 분석 및 관련 문제 풀이\n- 적용 예제 : 개념과 문제의 1:1 연결, 학습한 실전개념을 곧바로 자작 N제에 적용\n- 셀프 주간지 : 5일간 개념, 기본, 심화. 도전, 학교별 기출 단계로 누적 완전 학습!!\n\n2. 기본 문풀 : PROBLEM SOLVING - SCHEMA 1.0 \n\n- 문제 풀이 : 완자, EBS, 기출픽 등 시중 주요 교재를 모조리 변형한 N제 \n- 문제 분석 : 준우T의 실전 개념대로 문제를 분석, 고등 내신에 맞는 실력 갖추기  \n\n3. 학교별 분석 : PROBLEM - SOLVING - SCHEMA 2.0 (진도에 맞추어 제공)\n\n- 문제 풀이 : 화성, 가온, 병점, 영덕 등 영통권 주요 고교 기출 변형 맛보기 N제\n- 문제 분석 : 학습한 개념이 문제에 적용되는 과정 분석, 고등 성적 미리 완성하기\n\n4. 개인별 클리닉 자료 : IT'S ONLY YOURS - SCHEMA (과제 성적 기반으로 제공) \n \n- 개념 : 고등 과학이 처음이라 버거워도 걱정 NO! 개인 맞춤 복습지 무한 제공\n- 문제 : 어렵다면 기초 문제를 더! 할 만 하다면 도전 문제까지! 개인 맞춤 과제물!\n\n[과제/TEST]\n1. 과제 : 본교재 + 주간지 + 문풀 교재 + 개별 클리닉 과제 = 개인 맞춤 누적 학습 \n2. Test : 과제 변형 (4) + 대표 유형 (4) + 도전 유형 (2) = 학교 시험과 유사한 구성 \n3. 과제/Test 피드백 : 자체 포털에서 문항별 성적 세부 분석 + 석차/예상 등급 공개!\n\n[관리 SYSTEM 및 CLINIC]\n• 1. 과제/Test 미통과 : 직후 클리닉에서 결손 보충 후 하원 가능 \n2. 대면 자율 클리닉 : 수업에서 놓친게 있더라도, 강사가 직접 일대일 밀착 케어!: 1. 과제/Test 미통과 : 직후 클리닉에서 결손 보충 후 하원 가능 \n2. 대면 자율 클리닉 : 수업에서 놓친게 있더라도, 강사가 직접 일대일 밀착 케어!\n\n[회차별 내용]\n• 개강일 / 회차: 7/11(토) /15회\n• 1회차: 통과1 화학파트 - 원소의 주기성과 화학 결합 (1)\n• 2회차: 통과1 화학파트 - 원소의 주기성과 화학 결합 (2)\n• 3회차: 통과1 물리파트 - 중력 (1)\n• 4회차: 통과1 물리파트 - 중력 (2) + 운동량과 충격량\n• 5회차: 통과1 지구파트 - 빅뱅 우주론과 스펙트럼\n• 6회차: 통과1 지구파트 - 별의 진화와 태양계의 형성\n• 7회차: 퉁과1 생명파트 - DNA의 구조 및 유전\n• 8회차: 통과1 생명파트 - 세포의 구조와 효소의 작용\n• 9회차: 통과2 화학파트 - 산화와 환원\n• 10회차: 통과2 화학파트 - 산 염기 중화반응\n• 11회차: 통과2 물리파트 - 전가기 유도 + 에너지 발전\n• 12회차: 통과2 생명파트 - 변이 + 생태계 평형\n• 13회차: 통과2 지구파트 - 지질시대 + 진화\n• 14회차: 통과2 지구파트 - 대기 대순환 + 엘니뇨와 라리냐\n• 15회차: 통과1 기타파트 - 과학의 기초 + 통합과학 총정리\n\n[연계 강좌]\n• 방학 기간 중: 황준우T 예비고1 통합과학 / 황준우T 예비고1 물리학 (계속반)\n• 썸머 종강 후: 황준우T 예비고1 통합과학 / 황준우T 예비고1 물리학 (계속반)" },
      { division:'고1', category:'curriculum', display_order:16,
        title:"[고등] 통과 - 황준우T [연합1]",
        content:"[수업 일정]\n일10:00-13:00\n\n[강좌 특징]\n\"서울대 전공자의 뇌를 그대로 이식받는, 황준우 SCHEMA 과학\"\n\n1. 모든 개념을 스토리텔링, 암기하지 않고도 기억하는 비법 강의!\n2. 개념과 문제의 1:1 대응, 모든 개념을 '실전화'한 실전 개념 강의!\n3. 물리/화학도 더 이상 두렵지 않다, 킬러 유형별 풀이 알고리즘 강의!\n4. 생물/지구도 암기로는 부족하다, 학교별 빈출 함정과 자료의 패턴 강의!\n5. 실전에서의 실수까지 컨트롤 하는, 주제별 빈출 함정과 실수 요소까지 분석!\n\n[교재/제공자료]\n1. 개념 : SCIENCE - SCHEMA 1 + SELF - SCHEMA 주간지 \n\n- 기본 개념 : 교과서 모든 개념을 '암기' 없이 '기억'하는 법 학습\n- 실전 개념 : 물화생지 모든 개념을 '실전화'한 풀이 알고리즘 분석 \n- 자료 분석 : 강남/영통권 빈출 그림, 실험, 그래프 완벽 분석 및 관련 문제 풀이\n- 적용 예제 : 개념과 문제의 1:1 연결, 학습한 실전개념을 곧바로 자작 N제에 적용\n- 셀프 주간지 : 5일간 개념, 기본, 심화. 도전, 학교별 기출 단계로 누적 완전 학습!!\n\n2. 기본 문풀 : PROBLEM SOLVING - SCHEMA 1.0 \n\n- 문제 풀이 : 완자, EBS, 기출픽 등 시중 주요 교재를 모조리 변형한 N제 \n- 문제 분석 : 준우T의 실전 개념대로 문제를 분석하며 개념을 실전에 쓸 수 있도록  \n\n3. 학교별 분석 : PROBLEM - SOLVING - SCHEMA 2.0 및 3.0\n\n- 문제 풀이 : 학교별 기출 + 프린트 + 수업을 즉각 반영한 심화 개념 및 문풀\n- 문제 분석 : 개념 단계에서 학습했던 실전 개념을 반복하여 일관되게 적용 및 연습 \n\n4. 시험 직전 보강 : SCHEMA 모의고사 5회분 + 학교별 FINAL SCHEMA\n\n- 실전 모의고사 : 학교별로 모두 다른 모의고사, 학교 프린트 및 부교재 완벽 반영 \n- 직전 보강 자료 : 교과서와 프린트 주요 개념 총정리 + 학교별 주요 예상문제 풀이\n\n5. 개인별 클리닉 자료 : IT'S ONLY YOURS - SCHEMA (과제 성적 기반으로 제공) \n \n- 개념 : 학생 개인별로 취약한 개념에 대해 추가적인 개념 복습장 제공\n- 문제 : 학생의 성적과 목표에 맞추어 기본부터 심화까지 다양한 클리닉 문항 제공\n\n[과제/TEST]\n1. 과제 : 본교재 + 주간지 + 문풀 교재 + 개별 클리닉 과제 = 개인 맞춤 학습 \n2. Test : 과제 변형 (4) + 대표 유형 (4) + 도전 유형 (2) = 학교 시험과 유사한 구성 \n3. 과제/Test 피드백 : 자체 포털에서 문항별 성적 세부 분석 + 석차/예상 등급 공개!\n\n[관리 SYSTEM 및 CLINIC]\n• 1. 과제/Test 미통과 : 직후 클리닉에서 결손 보충 후 하원 가능 \n2. 대면 자율 클리닉 : 지정된 시간에 참여, 학습 습관 전반을 일대일 밀착 케어: 1. 과제/Test 미통과 : 직후 클리닉에서 결손 보충 후 하원 가능 \n2. 대면 자율 클리닉 : 지정된 시간에 참여, 학습 습관 전반을 일대일 밀착 케어\n\n[회차별 내용]\n• 개강일 / 회차: 7/12 (일)\n• 1회차: OT + 산화와 환원 기본 개념\n• 2회차: 산화와 환원 심화 개념 + 중화 반응 기본 개념\n• 3회차: 중화 반응 심화 개념\n• 4회차: 전자기 유도 기본 개념 + 심화 개념\n• 5회차: 생명/지구 암기파트 핵심 정리 (1)\n• 6회차: 생명/지구 암기파트 핵심 정리 (2) + 학교별 기출 맛보기\n\n[연계 강좌]\n• 썸머 종강 후: 황준우T 고1 연합 통합과학 (일)" },
      { division:'고2', category:'curriculum', display_order:30,
        title:"[고등] 화학- 김종인 [고2 연합]",
        content:"[수업 일정]\n토14:00-17:00\n\n[강좌 특징]\n물질과 에너지의 개념 이해와 문제풀이\n\n[교재/제공자료]\n교재 : 물질과 에너지 - 완자(비상)\n제공자료 : 내신 만점을 위한 기출문제 및 단원별 문제제공\n\n[과제/TEST]\n과제 : 단원별 문제 / 기출문제\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 수업 전 15분 : 과제 체크 및 질의 응답 - 개별진행\n• 클리닉: 수업 후 15분 : 수업 피드백 및 클리닉 진행 - 개별진행\n\n[회차별 내용]\n• 개강일 / 회차: 7/18(토) / 5회\n• 1회차: 이상 기체 방정식,\n혼합 기체의 부분압력과 몰분율\n• 2회차: 액체 분자의 상호작용,\n액체의 종류\n• 3회차: 결정성 고체와 비결정성 고체\n수소 결합\n• 4회차: 농도에 따른 증기압, 끓는점, 어는점의 변화\n삼투현상\n• 5회차: 엔탈피를 이용한 열화학 반응식 표현\n헤스의 법칙과 엔트로피의 의미\n\n[연계 강좌]\n• 방학 기간 중: 물질과 에너지의 개념 이해와 문제풀이\n• 썸머 종강 후: 2학기 중간고사 내신대비" },
      { division:'고2', category:'curriculum', display_order:31,
        title:"[고등] 물리- 심규원 [고2 연합]",
        content:"[수업 일정]\n일13:30-16:30\n\n[강좌 특징]\n역학과 에너지 전체과정 완벽정리 강좌 - 고등 물리학 과정 중 난이도가 가장 높은 역학과 에너지 과정의 깔끔하고 완벽한 정리강좌\n\n[교재/제공자료]\n자체교재\n\n[과제/TEST]\n과제 : 자체교재 문항, test : 매회차 점검문항 test\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 방학기간 중에는 짧은 시간동안 많은 내용의 전달을 위해 과제체크는 생략됩니다.\n• 테스트: 매 회차 점검문항 test : 20문항, 20분을 통해 이전까지 내용의 완벽한 확인\n• 클리닉: 여름방학 특강의 짧은 일정의 특징에 의해 클리닉은 생략됩니다.\n\n[회차별 내용]\n• 개강일 / 회차: 7/17(금)/ 5회\n• 1회차: 포물선 운동, 등속원운동, 진자운동\n• 2회차: 케플러법칙, 일반상대성이론\n• 3회차: 열역학(열의 전달, 열역학1, 2법칙, 열기관과 엔트로피)\n• 4회차: 단진동과 탄성파\n• 5회차: 도플러효과, 정상파\n\n[연계 강좌]\n• 방학 기간 중: \n• 썸머 종강 후: " },
      { division:'중등', category:'curriculum', display_order:32,
        title:"[고등] 국어- 박소현 [중3/고1]",
        content:"[수업 일정]\n일 14:00-17:00 (7/12 개강)\n\n[강좌 특징]\n1. 고등학교 1학년 1학기 중간고사 내신 킬러 문법 예습\n2. 고등학교 필수 문학 개념어 학습 \n3. 갈래별 필수 문학 작품 학습\n\n[교재/제공자료]\n자체 제작 교재 사용 / 매주 자체 제작 주간지 & 분석지 제공\n\n[과제/TEST]\n자체 제작 주간지 & 분석지 제공 (모든 분석 해설 선생님 직접 작성 - 수업 연장 효과)\n매주 지난주까지의 수업 내용 누적 복습할 수 있는 자체 제작 하프 모의고사 실시 (학생 / 학부모님들께 매주 1:1 개별 약점 분석지 전송)\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 1. 매주 주간지 개별 피드백 제공\n2. 24시 카카오톡 1:1 질의 응답\n• 테스트: 매주 지난주까지의 수업 내용 누적 복습할 수 있는 자체 제작 하프 모의고사 실시 (학생 / 학부모님들께 매주 1:1 개별 약점 분석지 전송)\n• 클리닉: 중간 입반 학생, 보충이 필요한 학생에 한 해 개별 클리닉 진행\n\n[회차별 내용]\n• 개강일 / 회차: 7/12-9/06 (9회)\n• 1회차: 1. 화자와 대상 \n2. 시상 \n(+ 관련 현대시 기출 문제)\n3. 음운의 기본\n• 2회차: 1. 감정이입, 객관적 상관물 \n(+ 관련 현대시 기출 문제)\n2. 음운 변동 (1)\n• 3회차: 1. 감각적 / 공감각적 이미지 (+ 관련 현대시 기출 문제)\n2. 형태소\n• 4회차: 1. 대립적 이미지, 상승 / 하강 이미지  \n2. 시선의 이동\n (+ 관련 현대시 기출 문제)\n3. 단어\n• 5회차: 1. 유추\n2. 추상의 구체화\n3. 역설과 반어\n (+ 관련 현대시 기출 문제)\n4. 단어 (1)\n• 6회차: 1. 관조\n2. 대구, 동일시어 / 시구 반복, 연쇄\n (+ 관련 현대시 기출 문제)\n3. 단어 (2)\n• 7회차: 1. 설의\n2. 영탄\n3. 의인\n (+ 관련 현대시 기출 문제)\n4. 품사 (1)\n• 8회차: 1. 문답 / 대화체와 독백체\n2. 성찰과 반성\n (+ 관련 현대시 기출 문제)\n3. 품사 (2)\n• 9회차: 1. 음성 상징어\n (+ 관련 현대시 기출 문제)\n2. 문장\n\n[연계 강좌]\n• 방학 기간 중: X\n• 썸머 종강 후: 시즌 2 (10/4-10/18 (3주) 예상) - 필수 고전시어 & 필수 고전시 작품" },
      { division:'고1', category:'curriculum', display_order:33,
        title:"[고1] 영어 - 김연우T [수원고1]",
        content:"[수업 일정]\n월18:00-21:00\n\n[강좌 특징]\n2026년 1학기 기준 수원고에서 가장 많이 나왔던 문법, 낱말, 빈칸추론 위주의 수업 \n(고1 문제로 기본기 잡기 + 고2 문제로 심화형 잡기 = 정확히 절반씩)\n\n[교재/제공자료]\n자체 교재\n\n[과제/TEST]\n매번 과제 있으며, 매번 단어시험 진행\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 과제여부, 단어 시험 합격 여부는 학생, 어머님께 다 공지됨\n• 테스트: 본수업 시작 전, 단어 TEST\n• 클리닉: 단어 불합격시, 일찍와서 재시험 진행 / 모르는 문제는 카톡으로 다 받아줌. (질문 많을 시, 전화로도 진행됨)\n\n[회차별 내용]\n• 개강일 / 회차: 7/13-8/17(6회)\n• 1회차: 빈칸추론 (1) --> 커리큘럼은 추후 변경될 수 있음.\n• 2회차: 빈칸추론 (2)\n• 3회차: 어색한 낱말 찾기\n• 4회차: 순서배열\n• 5회차: 문법 (1)\n• 6회차: 문법 (2)\n\n[연계 강좌]\n• 방학 기간 중: \n• 썸머 종강 후: " },
      { division:'고1', category:'curriculum', display_order:34,
        title:"[고등] 영어 - 대니얼T [화성고1]",
        content:"[수업 일정]\n금 16:30~20:00 (총 5회), 토 수업과 동일하므로 필요시 대체등원 가능\n\n[강좌 특징]\n·부족한 부분을 메꾸는 방학특강 + 2학기 내신 준비가 더해진 하이브리드 수업\n·화성고 기출 기반+ 학생들이 가장 어려워하는 어법/빈칸/순서/삽입 집중 공략\n·약점을 위한 개별과제 (예: 문장삽입이 약함 → 선별된 문장삽입 40제 확인/질답)\n\n[교재/제공자료]\n· 방학용 자체 교재 <수능열음> (어법 및 독해문제 단권화) \n· 나만의 노트 (오답 정리용 영어 학습 플래너)\n· 약점유형별 추가 40문제 소책자 (개별과제 용)\n\n[과제/TEST]\n과제용 주간지, 화성고 기출 및 변형 TEST\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 미흡한 학생들만 클리닉 진행 (금 수업 후 2시간)\n• 테스트: 워드 마스터 2학기 수행대비 + 배운 내용에 대한 테스트 결과 주간 리포트 발송\n• 클리닉: 강사 직접 진행, 부족한 부분에 대해 질답\n\n[회차별 내용]\n• 개강일 / 회차: 7/10(금)  - 여름방학이 짧기 때문에 큰 변화를 주기보다는 내실을 다지는 것에 집중\n• 1회차 7/10(금): 어법) 필수 개념정리 및 모두 고르시오 문제에 적용하기 + 화성고 어법기출\n• 2회차 7/17(금): 빈칸) 문맥상 동의어와 G코드로 오답선지의 틀린 부분 딴지 걸기 + 화성고 빈칸기출\n• 3회차 7/24(금): 삽입) 주어진 글을 보지 않고 단절을 발견하기 (소/연/대/지 훈련1) + 화성고 삽입기출\n• 4회차 7/31(금): 순서) 선지 구성만으로도 글의 흐름 유추하기 (소/연/대/지 훈련2) + 화성고 순서기출\n• 5회차 8/7(금): 기타) 2학기 내신/모의고사 1등급을 위한 세부전략 + 화성고 기타유형기출 (제목 등)\n\n[연계 강좌]\n• 썸머 종강 후: 8/21(금) 화성고 1학년 2학기 중간대비 내신개강\n• 썸머 종강 후: 8/22(토) 화성고 1학년 2학기 중간대비 내신개강" },
      { division:'고2', category:'curriculum', display_order:35,
        title:"[고등] 영어 - 대니얼T [화성고2]",
        content:"[수업 일정]\n토14:00-17:00\n\n[강좌 특징]\n개설 X - 현 인원 6명 (노소정, 김희담, 고민철, 우지호, 홍영기, 하태욱)\n\n 온라인으로만 내신 수업 수강하던 인원 2명: 노소정, 홍영기\n 수학특강 신청자 n명: 하태욱, 우지호 and...?\n\n 본부장님과 잠시 대화했을 때 문브라더스 고2 특강도 있다고 들었음 \n 이상을 고려했을 때 고2 여름특강은 개설하지 않는 게 모두에게 유익해보임\n\n[교재/제공자료]\n\n\n[과제/TEST]\n\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: \n• 테스트: \n• 클리닉: \n\n[회차별 내용]\n• 1회차: \n• 2회차: \n• 3회차: \n\n[연계 강좌]\n• 방학 기간 중: \n• 썸머 종강 후: 8월 22일 (토) 내신 개강" },
      { division:'고1', category:'curriculum', display_order:36,
        title:"[고1] 영어 - 박지원T [영덕고]",
        content:"[수업 일정]\n월18:00-22:00\n\n[강좌 특징]\n독해 : [DE:CODE 1.0] 글 읽기의 본질적인 이해 / 어법 : [SVAC VOL.1] 고등 어법 실전 개념 및 SVAC 풀이 과정 정리\n\n[교재/제공자료]\n박지원T 자체교재 및 주간지 과제 배부\n\n[과제/TEST]\n교육청/평가원 기출 + 주요 학교 내신 기출 + 누적 범위 개념 TEST + 45min 실전 모의고사 진행\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 미이행시 추가 클리닉 진행\n• 테스트: 개별 성적표 발송 및 기준 점수 이하 학생 추가 클리닉 진행\n• 클리닉: 1:1 강사 및 조교팀장과 함께 진행\n\n[회차별 내용]\n• 개강일 / 회차: 7/20(월)\n• 1회차: [DE:CODE 1.0] 대의파악의 본질 [SVAC] 주어와 동사\n• 2회차: [DE:CODE 1.0] 강조의 원리 [SVAC] 준동사 / 형용사와 부사\n• 3회차: [DE:CODE 1.0] 반복의 원리 [SVAC] 관계사 / (대)명사\n• 4회차: [DE:CODE 1.0] 기출로 체화하기 - 주제편 [SVAC] 종합 실전 풀이 고1 기출\n• 5회차: [DE:CODE 1.0] 기출로 체화하기 - 빈칸편 [SVAC] 종합 실전 풀이 고2 기출\n• 6회차: [DE:CODE 1.0] 기출로 체화하기 - 종합편 [SVAC] 종합 실전 풀이 고3 기출\n\n[연계 강좌]\n• 방학 기간 중: \n• 썸머 종강 후: 2026-2학기 중간고사 내신대비 수업" },
      { division:'중등', category:'curriculum', display_order:37,
        title:"[초중등] 영어 - 박지원T [중3]",
        content:"[수업 일정]\n월14:00-17:00\n\n[강좌 특징]\n고등 어법 실전 개념 및 SVAC 풀이과정 정리 [중등 문법에서 고등 어법으로]\n\n[교재/제공자료]\n박지원T 자체교재 및 주간지 과제 배부\n\n[과제/TEST]\n교육청/평가원 어법 기출 + 주요 학교 내신 기출 + 누적 범위 개념 TEST\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 미이행시 추가 클리닉 진행\n• 테스트: 개별 성적표 발송 및 기준 점수 이하 학생 추가 클리닉 진행\n• 클리닉: 1:1 강사 및 조교팀장과 함께 진행\n\n[회차별 내용]\n• 개강일 / 회차: 7/20(월)\n• 1회차: [SVAC] 주어와 동사\n• 2회차: [SVAC] 준동사 / 형용사와 부사\n• 3회차: [SVAC] 관계사 / (대)명사\n• 4회차: [SVAC] 종합 실전 풀이\n\n[연계 강좌]\n• 방학 기간 중: \n• 썸머 종강 후: " },
      { division:'고1', category:'curriculum', display_order:38,
        title:"[고1] 수학 - 박종윤T [화성고1 공수2 집중반]",
        content:"[수업 일정]\n7/10 (10회)\n\n[강좌 특징]\n공수2 개념 및 유형 마스터\n\n[교재/제공자료]\n자체교재\n\n[과제/TEST]\n매시간 테스트 및 메신저를 통한 과제 인증제 실시, 부모님께 과제,테스트,피드백 결과 문자발송\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 매시간 숙제검사\n• 테스트: 매시간 30분 테스트 예정\n• 클리닉: 일요일 수업시간 전 or 메신저를 통한 클리닉\n\n[회차별 내용]\n• 1회차: 평면좌표\n• 2회차: 직선의 방정식\n• 3회차: 원의 방정식\n• 4회차: 도형의 방정식\n• 5회차: 집합\n• 6회차: 명제\n• 7회차: 절대부등식\n• 8회차: 함수\n• 9회차: 합성함수와 역함수\n• 10회차: 유리함수\n• 11회차: 무리함수\n• 12회차: 총정리\n\n[연계 강좌]\n• 방학 기간 중: \n• 썸머 종강 후: 화성고 수학집중반(내신대비)" },
      { division:'중등', category:'curriculum', display_order:39,
        title:"[중3] 수학 - 박종윤T [공통수학1]",
        content:"[수업 일정]\n7/22 (10회)\n\n[강좌 특징]\n1회독 학생들 대상. 공통수학1 기본 및 응용 난이도 문항 정복\n\n[교재/제공자료]\n쎈b + 심화 프린트(수원 인근학교 기출문항 or 모의고사)\n\n[과제/TEST]\n매시간 과제 체크 및 시험. 체크내용 문자발송\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 매시간 검사\n• 테스트: 전 수업시간에 배운 내용을 바탕으로 클리닉지 구성\n• 클리닉: 틀린문항 유사문제를 통한 클리닉지 구성\n\n[회차별 내용]\n• 1회차: 다항식의 연산,항등식\n• 2회차: 나머지정리, 인수분해\n• 3회차: 복소수\n• 4회차: 이차방정식\n• 5회차: 이차함수\n• 6회차: 여러가지 방정식\n• 7회차: 일차부등식\n• 8회차: 이차부등식\n• 9회차: 순열/조합\n• 10회차: 행렬\n\n[연계 강좌]\n• 방학 기간 중: \n• 썸머 종강 후: 대수 기본반" },
      { division:'중등', category:'curriculum', display_order:40,
        title:"[중3] 수학 - 박종윤T [공통수학2]",
        content:"[수업 일정]\n7/23~ 8회\n\n[강좌 특징]\n1회독 학생들 대상. 공통수학2 기본 및 응용 난이도 문항 정복\n\n[교재/제공자료]\n쎈b + 심화 프린트(수원 인근학교 기출문항 or 모의고사)\n\n[과제/TEST]\n매 시간 테스트 및 과제확인. 당일 문자발송\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 전 시간에 배운 내용을 바탕으로 테스트\n• 테스트: 클리닉시간에 테스트\n• 클리닉: 테스트 후 틀린 문제를 통한 반복\n\n[회차별 내용]\n• 1회차: 평면좌표+직선의방정식\n• 2회차: 원의방정식\n• 3회차: 도형의 이동\n• 4회차: 집합\n• 5회차: 명제\n• 6회차: 함수\n• 7회차: 유리함수\n• 8회차: 무리함수\n\n[연계 강좌]\n• 방학 기간 중: \n• 썸머 종강 후: 대수 기본반" },
      { division:'고1', category:'curriculum', display_order:41,
        title:"[고1] 수학 - 최주용T [의치서반]",
        content:"[수업 일정]\n7월 11일 개강 / 토 18-22시\n\n[강좌 특징]\n내신, 모의고사 100점을 목표로 하는 최상위권 학생을 위한 수업\n\n[교재/제공자료]\n자체교재\n\n[과제/TEST]\n자체 워크북 (모의고사 준킬러 ~ 킬러 / 블랙라벨 수준)\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 매시간 수업 시작전 수거 후 검사, 개인별 오답노트 제공\n• 테스트: 1교시 (18:05-18:55) / 첨삭 및 개인별 오답노트 제공\n• 클리닉: 월~목 13:30~17:00\n\n[회차별 내용]\n• 1회차: 평면좌표와 직선의 방정식\n• 2회차: 원의 방정식, 도형의 이동\n• 3회차: 집합과 명제\n• 4회차: 함수\n• 5회차: 유리함수\n• 6회차: 무리함수\n\n[연계 강좌]\n• 방학 기간 중: 고1 대수 특강\n• 썸머 종강 후: 의치서반 (계속)" },
      { division:'고1', category:'curriculum', display_order:42,
        title:"[고1] 수학 - 최주용T [연합S반]",
        content:"[수업 일정]\n7월 9일 개강 / 화, 목 18-22시\n\n[강좌 특징]\n내신 1등급을 목표로 하는 학생 대상\n\n[교재/제공자료]\n자체교재\n\n[과제/TEST]\n자체 워크북 (모의고사 준킬러 / 내신고쟁이 수준)\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 매시간 수업 시작전 수거 후 검사, 개인별 오답노트 제공\n• 테스트: 1교시 (18:05-18:55) / 첨삭 및 개인별 오답노트 제공\n• 클리닉: 월~목 13:30~17:00\n\n[회차별 내용]\n• 1회차: 평면좌표와 직선의 방정식\n• 2회차: 직선의 방정식\n• 3회차: 원의 방정식\n• 4회차: 도형의 이동\n• 5회차: 집합\n• 6회차: 명제\n• 7회차: 함수\n• 8회차: 합성함수와 역함수\n• 9회차: 유리함수\n• 10회차: 무리함수\n\n[연계 강좌]\n• 방학 기간 중: 고1 대수 특강\n• 썸머 종강 후: 고1 S반 (계속)" },
      { division:'고1', category:'curriculum', display_order:43,
        title:"[고1] 수학 - 최주용T [대수 특강]",
        content:"[수업 일정]\n7월 22일 개강 / 월, 수, 금 09-12:30\n\n[강좌 특징]\n대수 1회독 이상의 학생\n\n[교재/제공자료]\n자체교재\n\n[과제/TEST]\n자체 워크북 (모의고사 준킬러 / 내신고쟁이 수준)\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 매시간 수업 시작전 수거 후 검사, 개인별 오답노트 제공\n• 테스트: 1교시 (09:05-09:30) / 개인별 오답노트 제공\n• 클리닉: 월~목 13:30~17:00\n\n[회차별 내용]\n• 1회차: 지수\n• 2회차: 로그\n• 3회차: 지수로그함수\n• 4회차: 삼각함수\n• 5회차: 삼각함수의 그래프\n• 6회차: 사인, 코사인 법칙\n• 7회차: 등차, 등비수열\n• 8회차: 수열의 합\n• 9회차: 수학적 귀납법\n\n[연계 강좌]\n• 방학 기간 중: 고1 S반, 의치서반\n• 썸머 종강 후: 고1 S반, 의치서반" },
      { division:'고1', category:'curriculum', display_order:44,
        title:"[고1] 수학 - 최주용T [화성고1 공수2]",
        content:"[수업 일정]\n7월 11일 개강 / 토, 일 14-17:30\n\n[강좌 특징]\n화성고1 내신 1등급을 목표로 하는 학생\n\n[교재/제공자료]\n자체교재\n\n[과제/TEST]\n자체 워크북 (모의고사 준킬러~킬러 / 블랙라벨 수준)\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 매시간 수업 시작전 수거 후 검사, 개인별 오답노트 제공\n• 테스트: 1교시 (14:05-14:30) / 첨삭 및 개인별 오답노트 제공\n• 클리닉: 금 17:00-21:00\n\n[회차별 내용]\n• 1회차: 평면좌표와 직선의 방정식\n• 2회차: 직선의 방정식\n• 3회차: 원의 방정식\n• 4회차: 도형의 이동\n• 5회차: 집합\n• 6회차: 명제\n• 7회차: 함수\n• 8회차: 합성함수와 역함수\n• 9회차: 유리함수\n• 10회차: 무리함수\n\n[연계 강좌]\n• 방학 기간 중: 화성고1 대수 / 미적분1\n• 썸머 종강 후: 화성고1 공수2 (계속)" },
      { division:'고2', category:'curriculum', display_order:45,
        title:"[고2] 수학 - 최주용T [연합 S]",
        content:"[수업 일정]\n7월 8일 개강 / 월, 수 18-22시\n\n[강좌 특징]\n미적분1 내신 1등급을 목표로 하는 학생 대상\n\n[교재/제공자료]\n자체교재\n\n[과제/TEST]\n자체 워크북 (모의고사 준킬러 / 내신고쟁이 수준)\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 매시간 수업 시작전 수거 후 검사, 개인별 오답노트 제공\n• 테스트: 1교시 (18:05-18:55) / 첨삭 및 개인별 오답노트 제공\n• 클리닉: 월~목 13:30~17:00\n\n[회차별 내용]\n• 1회차: 함수의 극한\n• 2회차: 함수의 연속\n• 3회차: 미분계수와 도함수\n• 4회차: 도함수의 활용(1)\n• 5회차: 도함수의 활용(2)\n• 6회차: 도함수의 활용(3)\n• 7회차: 도함수의 활용(4)\n• 8회차: 부정적분과 정적분\n• 9회차: 정적분(2)\n• 10회차: 정적분의 활용(1)\n• 11회차: 정적분의 활용(2)\n• 12회차: 정적분의 활용(3)\n\n[연계 강좌]\n• 방학 기간 중: \n• 썸머 종강 후: 고2 S반 (계속)" },
      { division:'고2', category:'curriculum', display_order:46,
        title:"[고2] 수학 - 최주용T [확통]",
        content:"[수업 일정]\n7월 11일 개강 / 토 09:30-13:00\n\n[강좌 특징]\n화성고2 내신 1등급을 목표로 하는 학생\n\n[교재/제공자료]\n자체교재\n\n[과제/TEST]\n자체 워크북 (모의고사 준킬러 / 내신고쟁이 수준)\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 매시간 수업 시작전 수거 후 검사, 개인별 오답노트 제공\n• 테스트: 1교시 (09:05-09:30) / 첨삭 및 개인별 오답노트 제공\n• 클리닉: 금 17:00-21:00\n\n[회차별 내용]\n• 1회차: 여러가지 순열\n• 2회차: 중복조합\n• 3회차: 이항정리\n• 4회차: 확률의 뜻과 활용\n• 5회차: 조건부확률\n• 6회차: 확률변수와 확률분포\n• 7회차: 이항분포와 정규분포\n• 8회차: 통계적 추정\n\n[연계 강좌]\n• 방학 기간 중: \n• 썸머 종강 후: 화성고2 확통 (계속)" },
      { division:'중등', category:'curriculum', display_order:47,
        title:"[중3] 수학 - 최주용T [공통수학2]",
        content:"[수업 일정]\n7월 23일 개강 / 화, 목 09-12:30\n\n[강좌 특징]\n중3 최상위권 학생 대상\n\n[교재/제공자료]\n자체교재\n\n[과제/TEST]\n자체 워크북 (모의고사 준킬러~킬러 / 블랙라벨 수준)\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 매시간 수업 시작전 수거 후 검사, 개인별 오답노트 제공\n• 테스트: 1교시 (09:05-09:30) / 개인별 오답노트 제공\n• 클리닉: 월~목 13:30~17:00\n\n[회차별 내용]\n• 1회차: 평면좌표와 직선의 방정식\n• 2회차: 직선의 방정식\n• 3회차 ): 원의 방정식\n• 4회차: 도형의 이동\n• 5회차: 집합\n• 6회차: 명제\n• 7회차: 함수\n• 8회차: 합성함수와 역함수\n• 9회차: 유리함수\n• 10회차: 무리함수\n\n[연계 강좌]\n• 방학 기간 중: \n• 썸머 종강 후: 중3 S반" },
      { division:'고1', category:'curriculum', display_order:48,
        title:"[고1] 수학 - 권소영T [연합A]",
        content:"[수업 일정]\n화/목 18:00 ~ 22:00\n\n[강좌 특징]\n1. 엄밀한 개념과 바로보는 예제를 통해 이해하기 쉬운 개념 학습, 매일보는 시험마다 개념 확인\n2. 체계화된 유형정리와 단계별로 정리된 문제 정복, 시험에 유용한 스킬을 반복적용하며 체화\n3. 매 수업 누적 단원 TEST, 과제 오답노트 제공, 학생별 시중교재를 하나 택하여 개별관리\n4. 강사가 직접 진행하는 클리닉, 풀이과정에 대한 첨삭도 꼼꼼하게 진행\n\n[교재/제공자료]\n권소영T 자체 본교재 및 워크북 + 과제 오답노트 + 누적 단원 TEST\n\n[과제/TEST]\n권소영T 자체 워크북 + 학생별 시중교재 + 매 수업 누적 단원 TEST 진행\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 클리닉 시간에 과제 완성(클리닉 필수 참여)\n추가로 오답노트가 과제로 제공되고 다음 수업날 제출(미제출 1회 경고, 2회 누적 시 상담)\n• 테스트: 매 수업 18:00 ~ 18:30 진행, 누적 단원 TEST\n• 클리닉: 월~금 13:30 ~ 17:00 (클리닉 필수 참여)\n\n[회차별 내용]\n• 1회차: 평면좌표\n• 2회차: 직선의 방정식\n• 3회차: 원의 방정식\n• 4회차: 도형의 이동\n• 5회차: 집합\n• 6회차: 명제\n• 7회차: 함수의 정의\n• 8회차: 합성함수와 역함수\n• 9회차: 유리함수\n• 10회차: 무리함수\n\n[연계 강좌]\n• 방학 기간 중: 고1 대수 기본+실력 특강\n• 썸머 종강 후: 고1연합A 2학기 내신대비반 (화목 18:00 ~ 22:00)" },
      { division:'고2', category:'curriculum', display_order:49,
        title:"[고2] 수학 - 권소영T [가온고1]",
        content:"[수업 일정]\n토/일 13:30 ~ 17:00\n\n[강좌 특징]\n1. 엄밀한 개념과 바로보는 예제를 통해 이해하기 쉬운 개념 학습, 매일보는 시험마다 개념 확인\n2. 체계화된 유형정리와 단계별로 정리된 문제 정복, 시험에 유용한 스킬을 반복적용하며 체화\n3. 매 수업 누적 단원 TEST, 과제 오답노트 제공, 학생별 시중교재를 하나 택하여 개별관리\n4. 제출된 과제에 대한 풀이과정 첨삭도 꼼꼼하게 진행\n\n[교재/제공자료]\n권소영T 자체 본교재 및 워크북 + 과제 오답노트 + 누적 단원 TEST\n\n[과제/TEST]\n권소영T 자체 워크북 + 학생별 시중교재 + 매 수업 누적 단원 TEST 진행\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 온라인 관리 (어플 질의응답 + 학생 및 학부모로 이루어진 톡방에 사진 제출)\n추가로 오답노트가 과제로 제공되고 다음 수업날 제출(미제출 1회 경고, 2회 누적 시 상담)\n• 테스트: 매 수업 13:30 ~ 17:00 진행, 누적 단원 TEST\n• 클리닉: 일요일 9:00 ~ 12:30 / 평일 등원이 가능한 경우 월~금 13:30 ~ 17:00\n\n[회차별 내용]\n• 1회차: 평면좌표\n• 2회차: 직선의 방정식\n• 3회차: 원의 방정식\n• 4회차: 도형의 이동\n• 5회차: 집합\n• 6회차: 명제\n• 7회차: 함수의 정의\n• 8회차: 합성함수\n• 9회차: 역함수\n• 10회차: 유리함수\n• 11회차: 무리함수\n\n[연계 강좌]\n• 방학 기간 중: 가온고 올데이 특강\n• 썸머 종강 후: 가온고1 2학기 내신대비반 (토/일 13:30 ~ 17:00)" },
      { division:'고1', category:'curriculum', display_order:50,
        title:"[고1] 수학 - 권소영T [대수 특강]",
        content:"[수업 일정]\n월/수/금 9:00 ~ 12:30\n\n[강좌 특징]\n1. 엄밀한 개념과 바로보는 예제를 통해 이해하기 쉬운 개념 학습, 매일보는 시험마다 개념 확인\n2. 체계화된 유형정리와 단계별로 정리된 문제 정복, 시험에 유용한 스킬을 반복적용하며 체화\n3. 매 수업 누적 단원 TEST, 과제 오답노트 제공, 학생별 시중교재를 하나 택하여 개별관리\n4. 강사가 직접 진행하는 클리닉, 풀이과정에 대한 첨삭도 꼼꼼하게 진행\n\n[교재/제공자료]\n권소영T 자체 본교재 및 워크북 + 과제 오답노트 + 누적 단원 TEST\n\n[과제/TEST]\n권소영T 자체 워크북 + 학생별 시중교재 + 매 수업 누적 단원 TEST 진행\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 클리닉 시간에 과제 완성(클리닉 필수 참여)\n추가로 오답노트가 과제로 제공되고 다음 수업날 제출(미제출 1회 경고, 2회 누적 시 상담)\n• 테스트: 매 수업 9:00 ~ 9:30 진행, 누적 단원 TEST\n• 클리닉: 월~금 13:30 ~ 17:00 (클리닉 필수 참여)\n\n[회차별 내용]\n• 1회차: 지수\n• 2회차: 로그\n• 3회차: 지수함수\n• 4회차: 로그함수\n• 5회차: 삼각함수의 정의\n• 6회차: 삼각함수의 그래프(1)\n• 7회차: 삼각함수의 그래프(2)\n• 8회차: 등차수열과 등비수열\n• 9회차: 수열의 합\n\n[연계 강좌]\n• 방학 기간 중: 고1연합A\n• 썸머 종강 후: 고1연합A 2학기 내신대비반 (화목 18:00 ~ 22:00)" },
      { division:'고1', category:'curriculum', display_order:51,
        title:"[고1] 수학 - 권소영T [가온고1 올데이 특강]",
        content:"[수업 일정]\nLive) 화목 9:00 ~ 12:30 (7/21 ~ 8/6) / 현강) 월화수목금 13:30 ~ 17:00\n\n[강좌 특징]\n1. 엄밀한 개념과 바로보는 예제를 통해 이해하기 쉬운 개념 학습, 매일보는 시험마다 개념 확인\n2. 체계화된 유형정리와 단계별로 정리된 문제 정복, 시험에 유용한 스킬을 반복적용하며 체화\n3. 매 수업 누적 단원 TEST, 과제 오답노트 제공, 학생별 시중교재를 하나 택하여 개별관리\n4. 강사가 직접 진행하는 클리닉, 풀이과정에 대한 첨삭도 꼼꼼하게 진행\n5. 계절학기 기간에도 선행 할 수 있도록 라이브 수업 제공\n\n[교재/제공자료]\n권소영T 자체 본교재 및 워크북 + 과제 오답노트 + 누적 단원 TEST\n\n[과제/TEST]\n권소영T 자체 워크북 + 학생별 시중교재 + 매 수업 누적 단원 TEST 진행\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 계절학기 기간동안 온라인 관리 (어플 질의응답 + 학생 및 학부모로 이루어진 톡방에 사진 제출)\n올데이 기간동안 클리닉 시간에 과제 완성(클리닉 필수 참여)\n추가로 오답노트가 과제로 제공되고 다음 수업날 제출(미제출 1회 경고, 2회 누적 시 상담)\n• 테스트: 매 수업 13:30 ~ 14:00 진행, 누적 단원 TEST\n• 클리닉: 올데이 기간동안 월~금 9:00 ~ 12:30 (클리닉 필수 참여)\n\n[회차별 내용]\n• 1회차: 지수\n• 2회차: 로그\n• 3회차: 지수함수\n• 4회차: 로그함수\n• 5회차: 삼각함수의 정의\n• 6회차: 삼각함수의 그래프(1)\n• 7회차: 삼각함수의 그래프(2)\n• 8회차: 삼각함수의 활용\n• 9회차: 등차수열과 등비수열\n• 10회차: 수열의 합\n• 11회차: 수학적 귀납법\n\n[연계 강좌]\n• 방학 기간 중: 가온고1 정규반\n• 썸머 종강 후: 가온고1 2학기 내신대비반 (토/일 13:30 ~ 17:00)" },
      { division:'고2', category:'curriculum', display_order:52,
        title:"[고2] 수학 - 권소영T [연합A1]",
        content:"[수업 일정]\n월/수 18:00 ~ 22:00\n\n[강좌 특징]\n1. 엄밀한 개념과 바로보는 예제를 통해 이해하기 쉬운 개념 학습, 매일보는 시험마다 개념 확인\n2. 체계화된 유형정리와 단계별로 정리된 문제 정복, 시험에 유용한 스킬을 반복적용하며 체화\n3. 매 수업 누적 단원 TEST, 과제 오답노트 제공, 학생별 시중교재를 하나 택하여 개별관리\n4. 강사가 직접 진행하는 클리닉, 풀이과정에 대한 첨삭도 꼼꼼하게 진행\n\n[교재/제공자료]\n권소영T 자체 본교재 및 워크북 + 과제 오답노트 + 누적 단원 TEST\n\n[과제/TEST]\n권소영T 자체 워크북 + 학생별 시중교재 + 매 수업 누적 단원 TEST 진행\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 클리닉 시간에 과제 완성(클리닉 필수 참여)\n추가로 오답노트가 과제로 제공되고 다음 수업날 제출(미제출 1회 경고, 2회 누적 시 상담)\n• 테스트: 매 수업 18:00 ~ 18:30 진행, 누적 단원 TEST\n• 클리닉: 월~금 13:30 ~ 17:00 (클리닉 필수 참여)\n\n[회차별 내용]\n• 1회차: 함수의 극한\n• 2회차: 함수의 연속\n• 3회차: 미분계수와 도함수\n• 4회차: 접선의 방정식\n• 5회차: 함수의 그래프 이론\n• 6회차: 미분 활용\n• 7회차: 부정적분\n• 8회차: 정적분\n• 9회차: 정적분의 활용(1)\n• 10회차: 정적분의 활용(2)\n\n[연계 강좌]\n• 방학 기간 중: \n• 썸머 종강 후: 고2연합A1 2학기 내신대비반 (화목 18:00 ~ 22:00)" },
      { division:'고2', category:'curriculum', display_order:53,
        title:"[고2] 수학 - 권소영T [가온고2]",
        content:"[수업 일정]\n토/일 9:00 ~ 12:30\n\n[강좌 특징]\n1. 엄밀한 개념과 바로보는 예제를 통해 이해하기 쉬운 개념 학습, 매일보는 시험마다 개념 확인\n2. 체계화된 유형정리와 단계별로 정리된 문제 정복, 시험에 유용한 스킬을 반복적용하며 체화\n3. 매 수업 누적 단원 TEST, 과제 오답노트 제공, 학생별 시중교재를 하나 택하여 개별관리\n4. 제출된 과제에 대한 풀이과정 첨삭도 꼼꼼하게 진행\n\n[교재/제공자료]\n권소영T 자체 본교재 및 워크북 + 과제 오답노트 + 누적 단원 TEST\n\n[과제/TEST]\n권소영T 자체 워크북 + 학생별 시중교재 + 매 수업 누적 단원 TEST 진행\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 온라인 관리 (어플 질의응답 + 학생 및 학부모로 이루어진 톡방에 사진 제출)\n추가로 오답노트가 과제로 제공되고 다음 수업날 제출(미제출 1회 경고, 2회 누적 시 상담)\n• 테스트: 매 수업 13:30 ~ 17:00 진행, 누적 단원 TEST\n• 클리닉: 일요일 13:30 ~ 17:00 / 평일 등원이 가능한 경우 월~금 13:30 ~ 17:00\n\n[회차별 내용]\n• 1회차: 함수의 극한\n• 2회차: 함수의 연속\n• 3회차: 미분계수와 도함수\n• 4회차: 접선의 방정식\n• 5회차: 함수의 그래프 이론\n• 6회차: 미분 활용\n• 7회차: 부정적분\n• 8회차: 정적분\n• 9회차: 정적분의 활용(1)\n• 10회차: 정적분의 활용(2)\n\n[연계 강좌]\n• 방학 기간 중: \n• 썸머 종강 후: 가온고2 2학기 내신대비반" },
      { division:'고2', category:'curriculum', display_order:54,
        title:"[고2] 수학 - 권소영T [공통수학1]",
        content:"[수업 일정]\n토/일 18:00 ~ 21:30\n\n[강좌 특징]\n1. 엄밀한 개념과 바로보는 예제를 통해 이해하기 쉬운 개념 학습, 매일보는 시험마다 개념 확인\n2. 체계화된 유형정리와 단계별로 정리된 문제 정복, 시험에 유용한 스킬을 반복적용하며 체화\n3. 매 수업 누적 단원 TEST, 과제 오답노트 제공\n4. 풀이과정에 대한 첨삭도 꼼꼼하게 진행\n\n[교재/제공자료]\n실력정석 + 블랙라벨 + 자체 프린트물 + 과제 오답노트 + 누적 단원 TEST\n\n[과제/TEST]\n블랙라벨 + 자체 프린트물 + 매 수업 누적 단원 TEST 진행\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 클리닉 시간에 과제 완성(클리닉 필수 참여)\n추가로 오답노트가 과제로 제공되고 다음 수업날 제출(미제출 1회 경고, 2회 누적 시 상담)\n• 테스트: 매 수업 13:30 ~ 17:00 진행, 누적 단원 TEST\n• 클리닉: 월~금 13:30 ~ 17:00 중 택 하루 이상\n\n[회차별 내용]\n• 1회차: 다항식과 나머지정리\n• 2회차: 인수분해\n• 3회차: 복소수\n• 4회차: 이차방정식과 이차함수\n• 5회차: 여러 가지 방정식\n• 6회차: 여러 가지 부등식\n• 7회차: 경우의 수\n• 8회차: 순열과 조합\n• 9회차: 행렬\n\n[연계 강좌]\n• 방학 기간 중: \n• 썸머 종강 후: 중3S 대수 실력반" },
      { division:'고2', category:'curriculum', display_order:55,
        title:"[고2] 수학 - 박병조T [기하]",
        content:"[수업 일정]\n매주 금요일 17:00~20:00\n\n[강좌 특징]\n<기하> 학습을 2회 이하 진행한 학생 대상으로 2학기 내신대비를 위한 기초 및 실전 개념 강좌\n\n[교재/제공자료]\n쎈 고등 기하(2026) / 5개년 EBS 우수문항\n\n[과제/TEST]\n지난 시간 학습 단원 / 매시간 15문항(30분) 테스트 실시\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: \n• 테스트: 매시간 누적 내용에 대한 테스트 응시 및 해설\n• 클리닉: 매시간 수업 종료 후 20:00~22:00 / 모든 문제에 대한 오답 정리 완료 후 하원\n\n[회차별 내용]\n• 1회차 : 7/10: 이차곡선(포물선, 타원)\n• 2회차 : 7/17: 이차곡선(쌍곡선), 이차곡선의 접선\n• 3회차 : 7/24: 공간도형\n• 4회차 : 7/31: 공간좌표, 벡터의 연산\n• 5회차 : 8/7: 벡터의 연산, 벡터의 성분과 내적\n• 6회차 : 8/14: 벡터의 성분과 내적, 공간도형의 방정식\n\n[연계 강좌]\n• 방학 기간 중: \n• 썸머 종강 후: <기하> 2학기 내신대비반 운영 예정" },
      { division:'고1', category:'curriculum', display_order:17,
        title:"[고1] 수학 - 황해룡T [영덕고1 S] (10회)",
        content:"[수업 일정]\n화목 18:00~22:00\n\n[강좌 특징]\n영덕고 내신 1등급을 목표로 하는 학생 (공통수학2 2회독 이상 학생 대상)\n내신 고난도 주제와 모의고사 고난도 기출문제의 풀이를 통해 내신과 모의고사 고득점 만들기\n\n■ 한 명을 위한 맞춤형 학습\n강사 직접 1:1 밀착 클리닉\n학생 개인별 취약 유형/유사문항 반복 체화를 통한 맞춤형 학습\n학생 개별 첨삭과 피드백 진행 (과제, 테스트에 대해 꼼꼼하게 분석 및 교정)\n\n■ 영덕고1을 위한 맞춤형 교재 및 커리큘럼\n학교별 부교재/프린트/교과서 유사동형 문항 반복훈련 (학교 부교재, 프린트 5배수 변형문항)\n오직 영덕고만을 위한 내신대비 자료와 실전 모의고사 제공\n\n■ 학원 이후에도 이어지는 ALL-CARE \n복습 동영상 제공\n손풀이 해설집 제공\n\n[교재/제공자료]\n자체교재+자체 워크북\n\n[과제/TEST]\n과제 : 공통 워크북 (유형서) + 개인별 워크북 (난이도별 추가문항) : 황해룡T 자체 워크북\n매시간 12문항 TEST + 누적 TEST + 기출 3번 회독 + 부교재 5배수 문항 제공\n\n[관리 SYSTEM 및 CLINIC]\n• 과제 체크: 과제 매시간 검사 + 첨삭 + 누적 과제 검사 및 제출율 추적 + 3회 과제 미제출시 상담 진행\n• 테스트: 복습 TEST 점수 미달자 상담 및 대체과제 제공\n• 클리닉: 금 18:00-22:00 / 토 14:00-19:00 / 일 18:00-22:00\n\n[회차별 내용]\n• 1회차 (7월 9일): 평면좌표와 평면도형의 성질\n• 2회차 (7월 14일): 직선의 방정식\n• 3회차 (7월 16일): 원의 방정식\n• 4회차 (7월 21일): 도형의 이동\n• 5회차 (7월 23일): 집합\n• 6회차 (7월 28일): 명제\n• 7회차 (7월 30일): 함수\n• 8회차 (8월 4일): 합성함수와 역함수\n• 9회차 (8월 6일): 유리함수\n• 10회차 (8월 11일): 무리함수\n\n[연계 강좌]\n• 방학 기간 중: 고1 대수특강 (황해룡T)\n• 썸머 종강 후: 영덕고 S반 정규" },
